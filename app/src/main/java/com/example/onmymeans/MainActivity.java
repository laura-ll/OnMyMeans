...
import com.example.onmymeans.model.IOItemAadapter;
import com.example.onmymeans.model.IOItem;
import com.example.onmymeans.model.BookItem;
import com.example.onmymeans.model.BookItemAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<BookItem> listItemBook = new ArrayList<>();

    private RecyclerView    ioItemRecyclerView;
    private IOItemAadapter ioAdapter;
                ...
                builder.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (sonView.findViewById(R.id.date_bar).getVisibility() == View.VISIBLE)
                            GlobalVariables.setDate("");
                        else GlobalVariables.setDate(ioAdapter.getItemDate(position));
...
//=============================================================================================================//
    ...
    protected void onResume() {
        ...
        BookItem tmp = DataSupport.find(BookItem.class, listItemBook.get(GlobalVariables.getmBookPos()).getId());
    ...
    public void initBookItemList(final Context context) {
        listItemBook = DataSupport.findAll(BookItem.class);

        if (listItemBook.isEmpty()) {
    ...
    public void setIoItemRecyclerView(Context context) {
        ...
        ioAdapter = new IOItemAadapter(IOItemList);
    ...
    public void setBookItemRecyclerView(Context context) {
        ...
        bookAdapter = new BookItemAdapter(listItemBook);
        ...
        bookAdapter.setOnItemClickListener(new BookItemAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                GlobalVariables.setmBookId(listItemBook.get(position).getId());
                onResume();
