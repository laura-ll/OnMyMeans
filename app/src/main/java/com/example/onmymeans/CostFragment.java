...
public class CostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            com.example.onmymeans.MyGridLayoutManager layoutManager = new com.example.onmymeans.MyGridLayoutManager(getContext(), 6);
            recyclerView.setLayoutManager(layoutManager);
            com.example.onmymeans.GridRecyclerAdapter adaper = new com.example.onmymeans.GridRecyclerAdapter(mDatas, i, pageSize);
            recyclerView.setAdapter(adaper);

            mPagerList.add(recyclerView);

            adaper.setOnItemClickListener(new com.example.onmymeans.GridRecyclerAdapter.OnItemClickListener() {
                @Override
        ...
        // 设置适配器
        mPager.setAdapter(new com.example.onmymeans.ViewPagerAdapter(mPagerList));
